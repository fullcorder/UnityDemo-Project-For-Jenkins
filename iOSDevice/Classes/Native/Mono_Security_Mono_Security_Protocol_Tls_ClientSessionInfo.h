...
struct  ClientSessionInfo_t670  : public Object_t
{
	...
	ByteU5BU5D_t576* ___sid_4;
	// System.Byte[] Mono.Security.Protocol.Tls.ClientSessionInfo::masterSecret
	ByteU5BU5D_t576* ___masterSecret_5;
};
struct ClientSessionInfo_t670_StaticFields{
