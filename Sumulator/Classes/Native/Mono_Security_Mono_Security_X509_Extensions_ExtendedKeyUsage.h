...
struct  ExtendedKeyUsageExtension_t648  : public X509Extension_t642
{
	// System.Collections.ArrayList Mono.Security.X509.Extensions.ExtendedKeyUsageExtension::keyPurpose
	ArrayList_t607 * ___keyPurpose_3;
};
struct ExtendedKeyUsageExtension_t648_StaticFields{
	...
	Dictionary_2_t152 * ___U3CU3Ef__switchU24map14_4;
};
