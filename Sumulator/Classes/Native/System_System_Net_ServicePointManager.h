...
struct  ServicePointManager_t755  : public Object_t
{
};
struct ServicePointManager_t755_StaticFields{
	// System.Collections.Specialized.HybridDictionary System.Net.ServicePointManager::servicePoints
	HybridDictionary_t785 * ___servicePoints_0;
	...
	RemoteCertificateValidationCallback_t768 * ___server_cert_cb_9;
};
