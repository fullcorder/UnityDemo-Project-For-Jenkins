...
struct  X509Store_t842  : public Object_t
{
	...
	X509Certificate2Collection_t836 * ___list_2;
	...
	X509Store_t643 * ___store_4;
};
struct X509Store_t842_StaticFields{
	...
	Dictionary_2_t152 * ___U3CU3Ef__switchU24mapF_5;
};
